// Ported from scipy.optimize.rectangular_lsap (C++ implementation):
//   reference/scipy/scipy/optimize/rectangular_lsap/rectangular_lsap.cpp
//   Shortest augmenting path algorithm (Crouse 2016, IEEE TAES).
//   Python wrapper: reference/scipy/scipy/optimize/_lsap.py
